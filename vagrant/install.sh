...
function setup_vtiger
{
	#setups vtiger install and sql db
	...
	#downloading and installing vtiger
	cd /var/www/html   #apache base directory is important!!!!
	wget -P /var/tmp --no-verbose http://sourceforge.net/projects/vtigercrm/files/vtiger%20CRM%206.3.0/Core%20Product/vtigercrm6.3.0.tar.gz
	...
	#setup index.php
	sudo rm index.html
	echo '<?php header( "Location: database" ) ; ?>' | sudo tee index.php
